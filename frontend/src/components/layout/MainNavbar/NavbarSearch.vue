<template>
  <div class="main-navbar__search w-100 d-none d-md-flex d-lg-flex" style="margin-bottom: 0 !important">
    <!-- <d-form class="main-navbar__search w-100 d-none d-md-flex d-lg-flex" style="margin-bottom: 0 !important"> -->
        <d-input-group class="ml-3" seamless>
            ...
            <d-input class="navbar-search" style="padding-left: 40px !important" @change="onRepo" placeholder="Search for one of your repos ( *repo group name*/*repo name* )" />
        </d-input-group>
    <!-- </d-form> -->
  </div>
</template>
