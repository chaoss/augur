...
<template>
  <div
    class="main-navbar__search w-100 d-none d-md-flex d-lg-flex navbarSearchDiv"
  >
    ...
    <d-input-group class="ml-3" seamless>
      ...
      <d-input
        class="navbar-search navbarSearchInput"
        @change="onRepo"
        placeholder="Search for one of your repos ( *repo group name*/*repo name* )"
      />
    </d-input-group>
    <!-- </d-form> -->
  </div>
...
@Options({
  methods: {
    ...mapActions("common", ["retrieveRepoIds"]),
    ...mapActions("compare", ["setBaseRepo", "setBaseGroup"]),
  },
  computed: {
    ...mapGetters("common", ["AugurAPI"]),
  },
  components: {},
})
