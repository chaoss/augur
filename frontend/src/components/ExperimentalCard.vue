...
<template>
  <section>
    ...
    <div class="row">
      ...
      <div class="col col-6">
        <dynamic-line-chart
          source="communityEngagement:issues_open"
      ...
      <div class="col col-6">
        <dynamic-line-chart
          source="communityEngagement:issues_closed_total"
...
import DualAxisContributions from "./charts/DualAxisContributions.vue";
