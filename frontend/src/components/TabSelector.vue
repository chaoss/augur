<template>
	...
	<d-button-group vertical>
      	...
      	<d-button v-if="getComparedReposNames.length > 0" outline :active="tab == 'repo_overview_compare'" style="font-size: 0.8rem" theme="info" @click="onTab" value="repo_overview_compare">Comparison</d-button>
    </d-button-group>
</template>
