    ...
    <div class="content">
      <div class="row auto">
        ...
        <nav class="col col-5 header-nav">
          <a class="header-nav-item loginlink" :href="logoutLink" v-if="user"
            >Logout</a
          >
          <router-link
            class="header-nav-item loginlink"
            to="/login"
            v-if="!user"
            >Login</router-link
          >
          <router-link
            ...
            >{{ user }}</router-link
          >
          <a class="header-nav-item" href="https://github.com/chaoss/augur"
            >GitHub</a
          >
          <a class="header-nav-item" href="/static/docs/">Python</a>
          <a class="header-nav-item" href="/static/api_docs/">API</a>
          <router-link class="header-nav-item" to="/metrics_status"
            >Metrics</router-link
          >
        </nav>
      </div>
