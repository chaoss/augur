...
export default class AugurAPI {
  ...
  constructor(hostURL: string = 'https://localhost:5099', version: string = '/api/unstable', autobatch: any = null) {
    this.__downloadedGitRepos = []

    this._version = version || '/api/unstable'
    this._host = hostURL || 'https://localhost:5099'
...
abstract class BaseRepo {
  ...
  constructor(parent: AugurAPI){
    this._host = parent._host || 'https://localhost:5099'
