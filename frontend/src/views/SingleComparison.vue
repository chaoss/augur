...
<template>
  <d-container fluid class="main-content-container px-4">
    <div class="row">
      ...
      <div class="col col-4" v-for="repo in compRepoNames" :key="repo">
...
@Options({
  ...
  computed: {
    ...mapGetters("common", ["apiRepos"]),
    ...mapGetters("compare", ["base", "comparedAPIRepos", "comparedRepos"]),
  },
})
export default class SingleComparison extends Vue {
  ...
  get compRepoNames() {
    return "names" in this.comparedRepos
      ? this.comparedRepos.names
      : this.comparedRepos;
  }
  ...
  created() {
    ...
    promises.push(
      this.comparedAPIRepos.forEach((repo: any) => {
  ...
  onTab(e: any) {
    ...
    this.$router.push({
      name: e.target.value,
      params: { repo: this.base.repo_name, group: this.base.rg_name },
    });
  }
}
</script>
