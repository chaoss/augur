...
riot.tag('healthreport', '<div class="container"> <section> <div class="row"> <div class="nine columns"><h1 id="repo-label">{owner} / {repo}</h1></div> </div> </section> <section> <div class="row"> <div class="twelve columns"> <h2>Response to Issues</h2> <issueshistogram></issueshistogram> </div> </div> <div class="row"> <div class="twelve columns"> <h2>Response to Issues</h2> <issueshistogram-v2></issueshistogram-v2> </div> </div> <div class="spacer"></div> <div class="row"> <div class="twelve columns"> <h2>Contributions</h2> <contributions></contributions> </div> </div> </section> </div>', function(opts) {
...
require.register("components/issueshistogram-v2.tag", function(exports, require, module) {
riot.tag('issueshistogram-v2', '<div class="issues-chart" style="width: 100%; height: 400px;"></div>', function(opts) {
