...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{attrs:{"id":"app"}},[_c('router-view')],1)])}
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('header',{staticClass:"hide-print"},[_c('div',{staticClass:"content"},[_c('div',{staticClass:"row auto"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"col col-4"},[_c('div',{staticClass:"form-item"},[_c('input',{staticClass:"search reposearch",attrs:{"type":"text","name":"headersearch","placeholder":"GitHub URL"},on:{"change":_vm.onRepo}})])]),_vm._v(" "),_c('nav',{staticClass:"col col-5 header-nav"},[(_vm.user)?_c('a',{staticClass:"header-nav-item loginlink",attrs:{"href":_vm.logoutLink}},[_vm._v("Logout")]):_vm._e(),_vm._v(" "),(!_vm.user)?_c('router-link',{staticClass:"header-nav-item loginlink",attrs:{"to":"/login"}},[_vm._v("Login")]):_vm._e(),_vm._v(" "),(_vm.user)?_c('router-link',{staticClass:"header-nav-item loginlink",attrs:{"to":"/profile"}},[_vm._v(_vm._s(_vm.user))]):_vm._e(),_vm._v(" "),_c('a',{staticClass:"header-nav-item",attrs:{"href":"https://github.com/chaoss/augur"}},[_vm._v("GitHub")]),_vm._v(" "),_c('a',{staticClass:"header-nav-item",attrs:{"href":"/static/docs/"}},[_vm._v("Python")]),_vm._v(" "),_c('a',{staticClass:"header-nav-item",attrs:{"href":"/static/api_docs/"}},[_vm._v("API")]),_vm._v(" "),_c('router-link',{staticClass:"header-nav-item",attrs:{"to":"/metrics_status"}},[_vm._v("Metrics")])],1)])])])}
...
;require.register("components/ErrorPage.vue", function(exports, require, module) {
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"limiter"},[_c('router-link',{attrs:{"to":"/"}},[_c('img',{attrs:{"src":"static/logo.png","id":"logo","alt":"CHAOSS: Community Health Analytics for Open Source Software"}})]),_vm._v(" "),_vm._m(0)],1)}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-login background"},[_c('h1',[_vm._v("Page Not Found")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ee0a88cc", __vue__options__)
  } else {
    hotAPI.reload("data-v-ee0a88cc", __vue__options__)
  }
})()}
});
...
module.exports = {
  ...
  created: function created() {
    ...
    var endpoints1 = ["commitComments", "totalCommitters", "contributionAcceptance", "communityEngagement:issues_open", "communityEngagement:issues_closed_total", "fakes", "newWatchers", "issueActivity", "contributors"];
...
var _CommitChart = require('./charts/CommitChart');
...
module.exports = {
  ...
  components: {
    ...
    CommitChart: _CommitChart2.default
  },
  computed: {
    repo: function repo() {
      return this.$store.state.baseRepo;
...
module.exports = {
  ...
  created: function created() {
    ...
    var endpoints1 = ["closedIssues", "codeReviewIteration"];
    window.AugurAPI.batchMapped(repos, endpoints1).then(function (data) {
      ...
      _this2.loaded1 = false;
      console.log("failed", error);
    });

    var endpoints2 = ["contributionAcceptance", "forks"];
    window.AugurAPI.batchMapped(repos, endpoints2).then(function (data) {
      ...
      _this2.loaded2 = false;
      console.log("failed", error);
    });

    var endpoints3 = ["codeCommits", "maintainerResponseToMergeRequestDuration"];
    window.AugurAPI.batchMapped(repos, endpoints3).then(function (data) {
      ...
      _this2.loaded3 = false;
      console.log("failed", error);
    });

    var endpoints4 = ["newContributingGithubOrganizations", "openIssues"];
    window.AugurAPI.batchMapped(repos, endpoints4).then(function (data) {
      console.log("here", data);
      endpoints4.forEach(function (endpoint) {
        _this2.values[endpoint] = {};
        _this2.values[endpoint][_this2.repo] = {};
        _this2.values[endpoint][_this2.repo][endpoint] = data[_this2.repo][endpoint];
      });
      ...
      _this2.loaded4 = false;
      console.log("failed", error);
    });

    var endpoints5 = ["pullRequestComments", "pullRequestsOpen", "contributingGithubOrganizations"];
    window.AugurAPI.batchMapped(repos, endpoints4).then(function (data) {
      console.log("here", data);
      endpoints5.forEach(function (endpoint) {
        _this2.values[endpoint] = {};
        _this2.values[endpoint][_this2.repo] = {};
        _this2.values[endpoint][_this2.repo][endpoint] = data[_this2.repo][endpoint];
      });
...
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wrap-input validate-input",attrs:{"data-validate":"Enter username"}},[_c('input',{staticClass:"input",attrs:{"type":"text","name":"username","placeholder":"Username"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wrap-input validate-input",attrs:{"data-validate":"Enter password"}},[_c('input',{staticClass:"input",attrs:{"type":"password","name":"password","placeholder":"Password"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contact-form-checkbox"},[_c('input',{staticClass:"input-checkbox",attrs:{"id":"ckb1","type":"checkbox"}}),_vm._v(" "),_c('label',{staticClass:"label-checkbox",attrs:{"for":"ckb1"}},[_vm._v("\n            Remember me\n          ")])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-login-form-btn"},[_c('input',{staticClass:"login-form-btn",attrs:{"type":"submit","value":"Login"}})])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
;require.register("components/ProjectDropdown.vue", function(exports, require, module) {
;(function(){
'use strict';
...
module.exports = {
  ...
  methods: {
    ...
    toggleSecNav: function toggleSecNav() {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{directives:[{name:"click-outside",rawName:"v-click-outside"}]},[_c('div',{staticStyle:{"display":"inline-block"}},[_c('div',{staticClass:"cd-dropdown-wrapper"},[_c('a',{staticClass:"cd-dropdown-trigger",attrs:{"href":"#0"},on:{"click":_vm.toggleNav}},[_vm._v(_vm._s(_vm.project))]),_vm._v(" "),_c('nav',{staticClass:"cd-dropdown"},[_c('h2',[_vm._v("Projects")]),_vm._v(" "),_c('a',{staticClass:"cd-close",attrs:{"href":"#0"}},[_vm._v("Close")]),_vm._v(" "),_c('ul',{staticClass:"cd-dropdown-content"},[_vm._m(0),_vm._v(" "),_c('li',{staticClass:"cd-divider"},[_vm._v("Projects")]),_vm._v(" "),_vm._l((_vm.projects),function(project){return _c('li',{staticClass:"has-children"},[_c('a',{attrs:{"href":"#0"},on:{"click":_vm.toggleSecNav}},[_vm._v(_vm._s(project))]),_vm._v(" "),_c('ul',{staticClass:"cd-secondary-dropdown  invis"},[_c('li',{staticClass:"has-children"},[_c('a',{attrs:{"href":"#0"}},[_vm._v("Repos")]),_vm._v(" "),_c('ul',{staticClass:"is-hidden"},_vm._l(((_vm.repos[project])),function(repo){return _c('li',{},[_c('a',{attrs:{"value":"","href":"#0"},on:{"click":_vm.toggleSelect}},[_vm._v(_vm._s(repo.url))])])}),0)])])])}),_vm._v(" "),_c('li',{staticClass:"has-children"}),_vm._v(" "),_c('li',{staticClass:"has-children"}),_vm._v(" "),_c('li',{staticClass:"cd-divider"},[_vm._v("Groups")]),_vm._v(" "),_vm._m(1)],2)])])])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',[_c('form',{staticClass:"cd-search",staticStyle:{"margin":"0"}},[_c('input',{attrs:{"type":"search","placeholder":"Search..."}})])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"has-children"},[_c('a',{attrs:{"href":"#0"}},[_vm._v("Test Group")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57324926", __vue__options__)
  } else {
    hotAPI.reload("data-v-57324926", __vue__options__)
  }
})()}
});
...
;require.register("components/charts/CommitChart.vue", function(exports, require, module) {
;(function(){
'use strict';
  ...
  computed: {
    ...
    spec: function spec() {
      ...
      var config = {
        ...
        "layer": [{
          ...
          "encoding": {
            ...
            "tooltip": [{ "field": this.care[0], "type": "nominal" }, { "field": this.care[1], "type": "nominal" }, { "field": this.care[2], "type": "nominal" }, { "field": this.care[3], "type": "nominal" }, { "field": this.care[4], "type": "nominal" }, { "field": this.care[5], "type": "nominal" }, { "field": this.care[6], "type": "nominal" }, { "field": this.care[7], "type": "nominal" }, { "field": this.care[8], "type": "nominal" }, {
              "field": "Total lines changed",
              "type": "quantitative"
            }, {
              "field": "Net lines added",
      ...
      var processData = function processData(data) {
        ...
        var ary = [];
        var template = { year: null, month: null, additions: 0, whitespace: 0, deletions: 0 };
        careabout.forEach(function (name) {
          findObjectByKey(data, "author_email", name).forEach(function (obj) {
            console.log(obj);

            var found = ary.some(function (el) {
            ...
            if (!found) {
              ...
              var el = ary.find(function (el) {
                return el.year == obj.author_date.getFullYear() && el.month == obj.author_date.getMonth();
              });
              if (!Object.keys(el).includes(obj.author_email)) {
                el[obj.author_email] = "additions: " + obj.additions;
                if (!_this.care.includes(obj.author_email)) {
                  _this.care.push(obj.author_email);
                }
              }
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20ed2e9a", __vue__options__)
  } else {
    hotAPI.reload("data-v-20ed2e9a", __vue__options__)
  }
})()}
});
...
exports.default = {
  ...
  }, _defineProperty(_methods, 'thisShouldTriggerRecompute', function thisShouldTriggerRecompute() {
    this.forceRecomputeCounter++;
  }), _defineProperty(_methods, 'respec', function respec() {
    this.spec;
  }), _defineProperty(_methods, 'reloadImage', function reloadImage(config) {
  ...
  }), _methods), mounted: function mounted() {
    this.spec;
  },
  created: function created() {
    var _this2 = this;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('d-card',{staticClass:"card-small"},[_c('d-card-header',{staticClass:"border-bottom"},[_c('h6',{staticClass:"m-0"},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),_c('div',{staticClass:"block-handle"})]),_vm._v(" "),_c('d-card-body',{staticClass:"p-0"},[_c('d-list-group',{staticClass:"list-group-small",attrs:{"flush":""}},_vm._l((_vm.referralData),function(item,idx){return _c('d-list-group-item',{key:idx,staticClass:"d-flex px-3"},[_c('span',{staticClass:"text-semibold text-fiord-blue"},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('span',{staticClass:"ml-auto text-right text-semibold text-reagent-gray"},[_vm._v(_vm._s(item.value))])])}),1)],1),_vm._v(" "),_c('d-card-footer',{staticClass:"border-top"},[_c('d-row',[_c('d-col',[_c('d-select',{staticStyle:{"max-width":"130px"},attrs:{"size":"sm","value":"last-week"}},[_c('option',{attrs:{"value":"last-week"}},[_vm._v("Last Week")]),_vm._v(" "),_c('option',{attrs:{"value":"today"}},[_vm._v("Today")]),_vm._v(" "),_c('option',{attrs:{"value":"last-month"}},[_vm._v("Last Month")]),_vm._v(" "),_c('option',{attrs:{"value":"last-year"}},[_vm._v("Last Year")])])],1),_vm._v(" "),_c('d-col',{staticClass:"text-right view-report"},[_c('a',{attrs:{"href":"#"}},[_vm._v("View full report →")])])],1)],1)],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"nav"},[_c('a',{staticClass:"nav-link nav-link-icon toggle-sidebar d-md-inline d-lg-none text-center",attrs:{"href":"#"},on:{"click":function($event){return _vm.handleClick()}}},[_c('i',{staticClass:"material-icons"},[_vm._v("")])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
=======
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('aside',{staticClass:"main-sidebar col-2 px-0",staticStyle:{"position":"fixed !important"}},[_c('div',{staticClass:"main-navbar"},[_c('nav',{staticClass:"navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0"},[_vm._m(0),_vm._v(" "),_c('a',{staticClass:"toggle-sidebar d-lg-none",on:{"click":function($event){return _vm.handleToggleSidebar()}}},[_c('i',{staticClass:"material-icons"},[_vm._v("sfdaf")])])])]),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('div',{staticClass:"nav-wrapper"},[_c('d-nav',{staticClass:"flex-column"},[_vm._l((_vm.items),function(item,navItemIdx){return _c('li',{key:navItemIdx,staticClass:"nav-item dropdown"},[_c('d-link',{directives:[{name:"d-toggle",rawName:"v-d-toggle",value:(("snc-" + navItemIdx)),expression:"`snc-${navItemIdx}`"}],class:['nav-link', item.items && item.items.length ? 'dropdown-toggle' : ''],attrs:{"to":item.to}},[(item.htmlBefore)?_c('div',{staticClass:"item-icon-wrapper",domProps:{"innerHTML":_vm._s(item.htmlBefore)}}):_vm._e(),_vm._v(" "),(item.title)?_c('span',{staticStyle:{"width":"240"}},[_vm._v(_vm._s(item.title))]):_vm._e(),_vm._v(" "),(item.htmlAfter)?_c('div',{staticClass:"item-icon-wrapper",domProps:{"innerHTML":_vm._s(item.htmlAfter)}}):_vm._e()]),_vm._v(" "),(item.items && item.items.length)?_c('d-collapse',{staticClass:"dropdown-menu dropdown-menu-small",attrs:{"id":("snc-" + navItemIdx),"accordion":"sidebar-items-accordion"}},_vm._l((item.items),function(subItem,subItemIdx){return _c('d-dropdown-item',{key:subItemIdx,attrs:{"href":subItem.href,"to":subItem.to}},[_vm._v("\n                "+_vm._s(subItem.title)+"\n              ")])}),1):_vm._e()],1)}),_vm._v(" "),_c('li',{staticClass:"nav-item dropdown",staticStyle:{"height":"240px !important","position":"absolute","bottom":"0","margin-top":"auto"}},[_c('d-link',{staticClass:"nav-link",staticStyle:{"font-size":"0.85rem"}},[_c('i',{staticClass:"material-icons"},[_vm._v("vertical_split")]),_vm._v(" "),_c('span',[_vm._v("Comparison Manager")]),_vm._v(" "),_c('div',{staticClass:"item-icon-wrapper"})]),_vm._v(" "),_c('div',{staticClass:"row",staticStyle:{"position":"absolute","bottom":"0","padding-left":"0px","width":"240px !important"}},[_c('div',{staticClass:"col col-6",staticStyle:{"padding":"0px"}},[_c('d-link',{staticClass:"nav-link",staticStyle:{"padding":"0px"}},[_c('i',{staticClass:"material-icons"},[_vm._v("autorenew")]),_vm._v(" "),_c('span',[_vm._v("Reset")]),_vm._v(" "),_c('div',{staticClass:"item-icon-wrapper"})])],1),_vm._v(" "),_c('div',{staticClass:"col col-6",staticStyle:{"padding":"0px"}},[_c('d-link',{staticClass:"nav-link",staticStyle:{"padding-left":"0px","padding":"0","display":"block"}},[_c('i',{staticClass:"material-icons"},[_vm._v("library_add")]),_vm._v(" "),_c('span',[_vm._v("Add comparison")]),_vm._v(" "),_c('div',{staticClass:"item-icon-wrapper"})])],1)])],1)],2)],1)])}
>>>>>>> Stashed changes
...
var _RepoOverview = require('./views/RepoOverview.vue');
...
var routes = [{
      ...
      children: [{
            ...
            components: {
                  sidebar: _MainSidebar2.default,
                  navbar: _MainNavbar2.default,
                  content: _RepoOverview2.default
            }
      }]
}, {
      path: '/blog-overview',
    ...
    getDownloadedRepos: function getDownloadedRepos() {
      ...
      window.AugurAPI.getRepoGroups().then(function (data) {
        ...
        _this.repo_groups.forEach(function (group) {
          _this.repo_relations[group.rg_name] = _this.repos;
          console.log(group, _this.repo_relations);
        });
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.reload("data-v-0153c3c4", __vue__options__)
  }
})()}
});
