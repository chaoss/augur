...
exports.default = {
  ...
  computed: {
    ...
    spec: function spec() {
      ...
      if (this.data) {
        processData(this.data).then(function () {
        ...
        window.AugurAPI.batchMapped(repos, endpoints).then(function (data) {
          ...
          _this.loading = false;
          if (data.length == 0) {
            $(_this.$el).find('.linechart').addClass('error');
            _this.renderError();
          }
        }, function () {
