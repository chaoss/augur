...
`Virtualbox <https://www.virtualbox.org/>`__. You’ll also need to
install `Vagrant <https://www.vagrantup.com/downloads.html>`__ and a Git client. To
...
`Facade <facade-oss.org>`__ and `GHTorrent <http://ghtorrent.org/>`__
datasets, both of which we rely on for a lot of our metrics. You’ll need
to provide Augur with a `GitHub Access
Token <https://github.com/settings/tokens>`__ (no write access
required).
...
development
guide <http://augur.augurlabs.io/static/docs/dev-guide/4-frontend.html>`__.
