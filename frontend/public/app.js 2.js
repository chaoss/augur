...
module.exports = {
  ...
  methods: {
    ...
    getSource: function getSource(endpoint) {
      var result = this.metricsData.filter(function (obj) {
        return obj.display_name == endpoint;
      });

      console.log("DICK", result);
