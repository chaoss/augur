...
class LoggerFactory:
    @staticmethod
    def create_logger(handler_tags: str, logfile_dir: str, worker_type: str, verbose: bool=False, debug: bool=False) -> AugurLogger:
        ...
        if ()
            logger.addHandler(logHandlerFactory.create_handler(handler_tags, logging.DEBUG))
        return logger
