...
class LoggerFactory:
    @staticmethod
    def create_logger(name: str, general_tags: str, handler_tags: HandlerTags, author: LogHandlerFactory.Author,
        ...
        log_handler_factory = LogHandlerFactory.LogHandlerFactory(general_tags, logfile_dir, author, verbose)
        # attach handlers
