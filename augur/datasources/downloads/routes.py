...
def create_routes(server):
    ...
    @apiDescription This is an Augur-specific metric. We are currently working to define these more formally. Source:  Source: <a href="https://developer.github.com/">GitHub API</a>
