...
def add_repo(project_id,git_repo):
...
def add_project(name, description, website):
...
def add_affiliation(domain, affiliation, start_date = ''):
...
def add_tag(email,start_date,end_date,tag):
