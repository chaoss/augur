...
def upgrade():
    op.add_column('platform_features', sa.Column('worker_run_id', sa.BIGINT(), autoincrement=False, nullable=True, comment='This column is used to indicate analyzes run by a worker during the same execution period, and is useful for grouping, and time series analysis.'))
