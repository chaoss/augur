"""add pretty name and enabled columns to platform_default

Revision ID: eae480bce055
Revises: None
Create Date: 2025-03-29 00:00:00.000000
...
def upgrade():
    ...
    op.add_column('platform_features', sa.Column('dep_name', sa.VARCHAR(), autoincrement=False, nullable=True, comment='Name of the dependency.'))
