...
def start_celery_collection_processes(vmem_cap_ratio):
    ...
    core_num_processes = determine_worker_processes(.01, 90)
    ...
    secondary_num_processes = determine_worker_processes(.01, 50)
    ...
    facade_num_processes = determine_worker_processes(.5, 50)
