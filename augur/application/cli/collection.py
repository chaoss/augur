...
def start_celery_collection_processes(vmem_cap_ratio):
    ...
    core_num_processes = determine_worker_processes(.040, 1)
    ...
    secondary_num_processes = determine_worker_processes(.039, 5)
    ...
    facade_num_processes = determine_worker_processes(.80, 70)
