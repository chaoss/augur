...
class ContributorsAlias(Base):
    ...
    __table_args__ = (
        ...
        # add uniques explitcitly, they were inline before
        UniqueConstraint('alias_email', name='AEmail-UNIQUE-C', initially="DEFERRED", deferrable=True),
        UniqueConstraint('canonical_email', name='ACanonical-UNIQUE-C', initially="DEFERRED", deferrable=True),
        {
            "schema": "augur_data",
