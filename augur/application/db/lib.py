...
def insert_gitlab_repo(url: str, repo_group_id: int, tool_source, repo_src_id = None):
    ...
    if not is_valid_repo_group_id(repo_group_id):
        return None
    ...
    result = bulk_insert_dicts(repo_data, Repo, repo_unique, return_columns, on_conflict_update=False)
...
def insert_github_repo(url: str, repo_group_id: int, tool_source, repo_type, repo_src_id = None):
    """Add a repo to the repo table.
