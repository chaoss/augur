"""Add pretty_name and enabled columns to platform

Revision ID: eae480bce055
Revises: 31
Create Date: 2025-03-29 16:59:41.106674
...
def upgrade():
    ...
    op.drop_index('repos_id', table_name='analysis_log')
    op.drop_table('analysis_log')
    op.drop_table('repo_badging')
    op.drop_table('documents_creators')
    op.drop_index('projects_id,affiliation_copy_2', table_name='dm_repo_group_monthly')
    op.drop_index('projects_id,email_copy_2', table_name='dm_repo_group_monthly')
    op.drop_index('projects_id,year,affiliation_copy_1', table_name='dm_repo_group_monthly')
    op.drop_index('projects_id,year,email_copy_1', table_name='dm_repo_group_monthly')
    op.drop_table('dm_repo_group_monthly')
...
def downgrade():
    ...
    sa.Column('platform_features', postgresql.JSONB(), nullable=True),
    ...
    sa.Column('id', sa.BIGINT(), server_default=sa.text("nextval('subscription_types_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    op.create_index('projects_id,year,email_copy_1', 'dm_repo_group_monthly', ['repo_group_id', 'year', 'email'], unique=False)
    op.create_index('projects_id,year,affiliation_copy_1', 'dm_repo_group_monthly', ['repo_group_id', 'year', 'affiliation'], unique=False)
    op.create_index('projects_id,email_copy_2', 'dm_repo_group_monthly', ['repo_group_id', 'email'], unique=False)
    op.create_index('projects_id,affiliation_copy_2', 'dm_repo_group_monthly', ['repo_group_id', 'affiliation'], unique=False)
    op.create_table('documents_creators',
    sa.Column('document_creator_id', sa.INTEGER(), server_default=sa.text("nextval('documents_creators_document_creator_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('document_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('creator_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['creator_id'], ['creators.creator_id'], name='documents_creators_creator_id_fkey'),
    sa.ForeignKeyConstraint(['document_id'], ['documents.document_id'], name='documents_creators_document_id_fkey'),
    sa.PrimaryKeyConstraint('document_creator_id', name='documents_creators_pkey')
    )
    op.create_table('repo_badging',
    sa.Column('badge_collection_id', sa.BIGINT(), server_default=sa.text("nextval('repo_badging_badge_collection_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('repo_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(precision=0), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('tool_source', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('tool_version', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('data_source', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('data_collection_date', postgresql.TIMESTAMP(precision=0), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['repo_id'], ['repo.repo_id'], name='fk_repo_badging_repo_1'),
    sa.PrimaryKeyConstraint('badge_collection_id', name='repo_badging_pkey'),
    ...
    sa.Column('repos_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('status', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('date_attempted', postgresql.TIMESTAMP(precision=0), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False)
    )
    op.create_index('repos_id', 'analysis_log', ['repos_id'], unique=False)
    # ### end Alembic commands ###
