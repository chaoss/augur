...
def upgrade():
    ...
    op.add_column('collection_status', sa.Column('core_weight', sa.BigInteger(), server_default=sa.text('0'), nullable=False), schema='augur_operations')
    op.add_column('collection_status', sa.Column('facade_weight', sa.BigInteger(), server_default=sa.text('0'), nullable=False), schema='augur_operations')
