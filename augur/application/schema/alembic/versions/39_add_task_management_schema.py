...
def upgrade():
    ...
    op.create_table('workflow_tasks',
        ...
        sa.Column('task_type', postgresql.ENUM('core', 'secondary', 'facade', name='task_type', schema='augur_operations'), nullable=False),
    ...
    op.create_table('repo_collections',
        ...
        sa.Column('workflow_id', sa.Integer(), nullable=False),
        sa.Column('origin', postgresql.ENUM('automation', 'manual', name='origin_type', schema='augur_operations'), nullable=False),
        sa.Column('collection_type', postgresql.ENUM('full', 'incremental', name='collection_type', schema='augur_operations'), nullable=False, server_default='full'),
        ...
        sa.Column('state', postgresql.ENUM('Collecting', 'Failed', 'Complete', name='collection_state', schema='augur_operations'), nullable=False, server_default='Collecting'),
    ...
    op.create_table('task_runs',
        ...
        sa.Column('state', postgresql.ENUM('Pending', 'Queued', 'Collecting', 'Failed', 'Complete', name='task_run_state', schema='augur_operations'), nullable=False, server_default='Pending'),
