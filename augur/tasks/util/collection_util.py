...
class CollectionRequest:
    ...
    def get_valid_repos(self,session):
        ...
        new_collection_repo_git_list = get_newly_added_repos(session, limit, hook=self.name)
        collection_list = [tuple(repo_git, True) for repo_git in new_collection_repo_git_list]
        ...
        recollection_repo_git_list = get_repos_for_recollection(session, limit, hook=self.name, days_until_collect_again=self.days_until_collect_again)
        collection_list = [tuple(repo_git, False) for repo_git in recollection_repo_git_list]
        self.repo_list.extend(collection_list)
