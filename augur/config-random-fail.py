...
contributor_breadth_worker_p = random.randint(48000, 48500)
facade_worker_p = random.randint(48501, 49000) 
insight_worker_p = random.randint(49002, 49500) 
metric_status_worker_p = random.randint(49501, 50000) 
pull_request_worker_p = random.randint(50001, 50500) 
repo_info_worker_p = random.randint(50501, 51000) 
value_worker_p = random.randint(51002, 51500) 
contributor_worker_p = random.randint(52000, 52500) 
message_insights_worker_p = random.randint(53000, 53499) 
pull_request_analysis_worker_p = random.randint(54000, 54500) 
discourse_analysis_worker_p = random.randint(54500, 54999)  
message_insights_worker_p = random.randint(55000, 55499) 
pull_request_analysis_worker_p = random.randint(56000, 56499) 
discourse_analysis_worker_p = random.randint(56500, 56999) 
clustering_worker_p = random.randint(57000, 57499)
github_worker_p = random.randint(57500, 58000)
linux_badge_worker_p = random.randint(47000,47499)
gitlab_issues_worker_p = random.randint(47500,47499)
release_worker_p = random.randint(46000,46499)
gitlab_merge_request_worker_p = random.randint(46500,46999)
main_port = random.randint(5001,5300) 
