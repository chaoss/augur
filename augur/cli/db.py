...
def update_org_repositories(augur_app, org):
    ...
    nonArchivedTotalCount = get_non_archived_repos_total_count(org)
    ...
    if nonArchivedTotalCount > len(existing_repos):
        repos = get_all_non_archived_repos(org, nonArchivedTotalCount)
...
def get_all_non_archived_repos(org, totalCount):
    maxCount = 100
    nodes = []
    after = ""
...
def get_non_archived_repos_total_count(org):
    query = """
    {
