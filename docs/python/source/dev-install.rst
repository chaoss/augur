...
2. `Dependency Installation for Ubuntu <#Fedora>`__
...
'augur' to create the augur.cfg file**
...
Edit the augur.cfg file with the the required information for database
and API connections.
