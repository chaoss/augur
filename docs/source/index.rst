...
This software is developed as part of the `CHAOSS <https://chaoss.community/>`_ (Community Health Analytics Open Source Software) project. Many of our metrics are implementations of the metrics defined by our awesome community. You can find more information about how to get involved on `the CHAOSS website <https://chaoss.community/>`_. If you want to see augur in action, you can view CHAOSS’s augur instance.
