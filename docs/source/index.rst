...
Welcome to the Augur project's official documentation. Below is a brief primer on the project and its goals; if you're new to the project, we recommend giving it an once-over as a gentle introduction. Otherwise, feel free to hop right into the docs!
