...
def main(augur_url, host, port):
    ...
    worker_info = read_config('Workers', 'linux_badge_worker', None, None)
    ...
    app.worker = BadgeWorker(config) # declares the worker that will be running on this server with specified config
