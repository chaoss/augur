        ...
        issues_insert = [
            {
                ...
                'pull_request': issue['pull_request']['url'].split('/') if 'pull_request' in issue else None,
                'pull_request_id': issue['pull_request']['url'].split('/') if 'pull_request' in issue else None,
