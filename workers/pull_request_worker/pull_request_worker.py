    ...
    def _get_pk_source_prs(self):
        ...
        def pk_source_increment_insert(inc_source_prs, action_map):
            ...
            prs_insert = [
            {
                ...
                'pr_body': pr['body'].encode(encoding = 'UTF-8', errors = ignore).replace("\x00", "\uFFFD"),
        ...
        pr_comments_insert = [
            {
                ...
                'msg_text': comment['body'].encode(encoding = 'UTF-8', errors = ignore).replace("\x00", "\uFFFD"),
        ...
        reviews_insert = [
            {
                ...
                'pr_review_body': review['body'].encode(encoding = 'UTF-8', errors = ignore).replace("\x00", "\uFFFD"),
