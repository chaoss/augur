    ...
    def _get_pk_source_prs(self):
        ...
        def pk_source_increment_insert(inc_source_prs, action_map):
            ...
            prs_insert = [
            {
                ...
                'pr_body': bytes(pr['body'], "utf-8").decode().encode(encoding='UTF-8',errors='ignore'),
        ...
        pr_comments_insert = [
            {
                ...
                'msg_text': bytes(pr['body'], "utf-8").decode().encode(encoding='UTF-8',errors='ignore'),
    ...
    def pull_request_reviews_model(self, pk_source_prs=[]):
        ...
        reviews_insert = [
            {
                ...
                'pr_review_body': bytes(review['body'], "utf-8").decode().encode(encoding='UTF-8',errors='ignore'),
       ...
       #  https://api.github.com/repos/chaoss/augur/pulls
        ...
        review_msg_insert = [
            {
                'pltfrm_id': self.platform_id,
                'msg_text': bytes(comment['body'], "utf-8").decode().encode(encoding='UTF-8',errors='ignore'),
                'msg_timestamp': comment['created_at'],
                'cntrb_id': comment['cntrb_id'],
                'tool_source': self.tool_source,
                'tool_version': self.tool_version,
