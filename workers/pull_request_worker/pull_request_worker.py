    ...
    def _get_pk_source_prs(self):
        ...
        def pk_source_increment_insert(inc_source_prs, action_map):
            ...
            prs_insert = [
            {
                ...
                'pr_body': bytes(pr['body'], "utf-8").encode().replace("\x00", "\uFFFD"),
        ...
        pr_comments_insert = [
            {
                ...
                'msg_text': bytes(comment['body'], "utf-8").encode().replace("\x00", "\uFFFD"),
        ...
        reviews_insert = [
            {
                ...
                'pr_review_body': bytes(review['body'], "utf-8").encode().replace("\x00", "\uFFFD"),
