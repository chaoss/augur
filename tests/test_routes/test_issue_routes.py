...
def test_issues_active_by_group():
...
def test_issues_active_by_repo():
...
def test_issues_closed_by_group():
...
def test_issues_closed_by_repo():
...
def test_issue_participants_by_repo():
...
def test_issue_throughput_by_group():
...
def test_issue_throughput_by_repo():
...
def test_issue_backlog_by_group():
...
def test_issue_backlog_by_repo():
...
def test_issues_first_time_opened_by_group():
...
def test_issues_first_time_opened_by_repo():
...
def test_issues_first_time_closed_by_group():
...
def test_issues_first_time_closed_by_repo():
...
def test_open_issues_count_by_group():
...
def test_open_issues_count_by_repo():
...
def test_closed_issues_count_by_group():
...
def test_closed_issues_count_by_repo():
...
def test_issues_open_age_by_group():
...
def test_issues_open_age_by_repo():
...
def test_issues_closed_resolution_duration_by_group():
...
def test_issues_closed_resolution_duration_by_repo():
...
def test_issues_maintainer_response_duration_by_repo():
...
def test_issues_maintainer_response_duration_by_group():
