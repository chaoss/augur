...
def test_code_changes_by_group():
...
def test_code_changes_lines_by_group():
...
def test_code_changes_lines_by_repo():
...
def test_sub_projects_by_group():
...
def test_annual_lines_of_code_count_ranked_by_new_repo_in_repo_group_by_group():
...
def test_annual_lines_of_code_count_ranked_by_repo_in_repo_group_by_repo():
...
def test_annual_lines_of_code_count_ranked_by_repo_in_repo_group_by_group():
