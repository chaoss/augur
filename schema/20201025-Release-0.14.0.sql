...
-- ----------------------------
ALTER TABLE "augur_data"."contributor_repo" DROP CONSTRAINT IF EXISTS "cntrb_repo_id_key" PRIMARY KEY ("cntrb_repo_id");
...
-- ----------------------------
ALTER TABLE "augur_data"."contributor_repo" DROP CONSTRAINT IF "fk_contributor_repo_contributors_1" FOREIGN KEY ("cntrb_id") REFERENCES "augur_data"."contributors" ("cntrb_id") ON DELETE RESTRICT ON UPDATE CASCADE;
