ALTER TABLE "spdx"."file_types" DROP CONSTRAINT "uc_file_type_name";

ALTER TABLE "spdx"."file_types" DROP  CONSTRAINT "file_types_pkey" CASCADE;
...
ALTER TABLE "spdx"."identifiers" DROP CONSTRAINT "ck_identifier_exactly_one";
...
ALTER TABLE "spdx"."packages" DROP CONSTRAINT "uc_sha256_ds2_dir_code_exactly_one";
