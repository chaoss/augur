...
SELECT setval('"augur_data"."message_analysis_msg_analysis_id_seq"', 1, false);

ALTER SEQUENCE "augur_data"."message_analysis_msg_analysis_id_seq"
OWNED BY "augur_data"."message_analysis"."msg_analysis_id";

ALTER SEQUENCE "augur_data"."message_analysis_msg_analysis_id_seq" OWNER TO "augur";

SELECT setval('"augur_data"."message_analysis_summary_msg_summary_id_seq"', 1, false);

ALTER SEQUENCE "augur_data"."message_analysis_summary_msg_summary_id_seq"
OWNED BY "augur_data"."message_analysis_summary"."msg_summary_id";
