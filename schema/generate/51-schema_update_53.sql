...
CREATE TABLE "augur_data"."repo_deps_scorecard" (
  ...
  "ossf_cii_best_practices_status" varchar COLLATE "pg_catalog"."default",
  ...
  "ossf_cii_best_practices_score" varchar COLLATE "pg_catalog"."default",
  ...
  "ossf_automated_dendency_update_score" varchar COLLATE "pg_catalog"."default",
  "ossf_token_permissions_score" varchar COLLATE "pg_catalog"."default",
...
update "augur_operations"."augur_settings" set value = 53  
