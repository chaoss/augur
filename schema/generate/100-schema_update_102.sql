...
AS
Select cntrb_id, created_at, month, year, repo_id, repo_name, full_name, login, rank from 
(
            SELECT * FROM (
                SELECT ID AS
                    cntrb_id,
                    ...
                    (
                       ...
                       /** WHERE
                        ...
                        WHERE
                            ...
                            /**AND commits.repo_id in (30347, 33226)**/ 
                        ...
                        /*WHERE
                            pull_requests.repo_id in (30347, 33226) **/
                        GROUP BY
        ...
        FROM
            ...
            WHERE
                (
                    ...
                    AND ( issues.pull_request IS NULL ) 
                    AND ( issue_events.cntrb_id IS NOT NULL ) 
                    AND ( issue_events.ACTION IN ( 'Open PR', 'PR Comment', 'Issue Opened', 'Issue Closed', 'Commit' ) ) 
                ) 
            GROUP BY
                issue_events.cntrb_id,
                issues.repo_id,
...
GRANT SELECT ON "augur_data"."explorer_contributor_actions" to PUBLIC; 
