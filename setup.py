...
setup(
    ...
    install_requires=['cython', 'protobuf', 'ipdb', 'setuptools-git', 'beautifulsoup4', 'flask', 'flask-cors', 'PyMySQL', 'requests', 'python-dateutil', 'sqlalchemy', 'pandas', 'pytest', 'PyGithub', 'dulwich', 'pyevent', 'gunicorn', 'datetime', 'traitlets'],
    extras_require={
        'dev': ['check-manifest'],
        'test': ['coverage'],
    },
