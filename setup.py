...
setup(
    ...
    install_requires=['ipdb', 'setuptools-git', 'beautifulsoup4', 'flask', 'flask-cors', 'PyMySQL', 'requests', 'python-dateutil', 'sqlalchemy', 'pandas', 'pytest', 'PyGithub', 'pyevent', 'gunicorn', 'datetime'],
    extras_require={
        'dev': ['check-manifest'],
        'test': ['coverage'],
    },
